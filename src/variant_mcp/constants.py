...
AMP_TIER_DEFINITIONS = {
    "I": {
        ...
        "level_B": (
            "Well-powered studies with expert consensus from clinical trials "
            "or large cohorts"
        ),
    },
    "II": {
...
KNOWN_TUMOR_SUPPRESSORS = {
    "TP53", "RB1", "BRCA1", "BRCA2", "APC", "PTEN", "VHL", "WT1", "NF1", "NF2",
    "CDKN2A", "SMAD4", "STK11", "MLH1", "MSH2", "MSH6", "PMS2", "CDH1", "PTCH1",
    "MEN1", "TSC1", "TSC2", "BMPR1A", "SMARCB1", "BAP1", "ARID1A", "KDM6A",
    "FBXW7", "RNF43", "ZNRF3", "LATS1", "LATS2", "FAT1", "AXIN1", "AXIN2",
}

# Known oncogenes (for classification context)
KNOWN_ONCOGENES = {
    "BRAF", "KRAS", "NRAS", "HRAS", "EGFR", "PIK3CA", "ALK", "RET", "MET",
    "KIT", "PDGFRA", "FGFR1", "FGFR2", "FGFR3", "ABL1", "JAK2", "MPL",
    "ERBB2", "ERBB3", "IDH1", "IDH2", "CTNNB1", "SMO", "GNA11", "GNAQ",
    "AKT1", "MAP2K1", "MAP2K2", "MTOR", "MYC", "MYCN", "MYCL", "CDK4",
    "CDK6", "CCND1", "CCND2", "CCND3", "MDM2", "MDM4",
}

# Null variant types (for OVS1 auto-detection)
NULL_VARIANT_TYPES = {
    "nonsense", "frameshift", "splice_site", "splice_donor", "splice_acceptor",
    "start_loss", "exon_deletion", "transcript_ablation",
}
